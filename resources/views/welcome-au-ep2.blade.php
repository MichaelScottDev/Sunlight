            ...
            <div class="fade-up mt-5 border border-paper/[0.07]" style="animation-delay:0.35s;background:rgba(12,8,4,0.7)">
                ...
                <div class="flex flex-wrap gap-0">
                    ...
                    <a href="/#rj" class="flex items-center gap-2 px-4 py-3 hover:bg-hot/8 border-r border-paper/[0.06] transition-all group">
                        ...
                        <div><div class="text-[0.6rem] text-paper/55 group-hover:text-paper transition-colors leading-none mb-0.5">RJ — 15 Incidents</div><div class="text-[0.47rem] text-paper/22 tracking-wider">Now in Episode 1</div></div>
                    </a>
        ...
        <div class="space-y-16">
            ...
            <div class="story-chapter reveal" style="border-left-color:rgba(124,106,170,0.3)">
                ...
                <div class="story-chapter reveal mt-6 mb-6" style="border-left-color:rgba(124,106,170,0.6)">
                    ...
                    <p class="text-[0.72rem] leading-relaxed text-paper/45 mb-3">Bodie is now telling everyone that his landlord — trading as <strong class="text-paper/65">haswon enterprises</strong> — is a <strong class="text-paper/65">sex trafficker</strong>. On Bodie's own account, the landlord is also a <strong class="text-paper/65">bikie</strong>, a <strong class="text-paper/65">money launderer</strong>, and someone who <strong class="text-paper/65">sells drugs</strong>. Whatever the truth of those claims, the effect is the same: by naming and provoking the network he chose to live inside, Bodie Chalmers has drawn scrutiny onto himself and everyone around him. This is heat he brought on himself — the direct consequence of his own conduct, his own mouth, and the company he keeps.</p>
                    <div class="reveal mb-2">
                        <img src="https://sunlightquest.s3.ap-southeast-2.amazonaws.com/bodie_chalmers/haswon_enterprises_smart_access_1.jpg" alt="Rent payment receipt to haswon enterprises — bank account details filtered" class="w-full border border-paper/[0.07]" style="max-height:520px;object-fit:contain;background:#0c0804" loading="lazy" />
                        <div class="text-[0.44rem] tracking-[0.14em] uppercase text-paper/25 mt-1.5">Payment receipt · Rent to haswon enterprises (Bodie's landlord) · $330 · 18 May 2026 · Bank account details filtered as per Claude's requirements</div>
                    </div>
                </div>
