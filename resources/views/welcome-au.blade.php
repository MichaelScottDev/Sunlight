...
<head>
    ...
    <style>
        ...
        /* When an image is taller than the viewport, keep the TOP reachable/scrollable instead of clipping it (flexbox centered-overflow fix) */
        .mv-body{align-items:safe center;justify-content:safe center}
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-12 reveal">
            ...
            <div class="space-y-px">
                ...
                <div class="grid grid-cols-[80px_1fr] gap-4 p-4" style="background:rgba(193,68,14,0.09);border:1px solid rgba(193,68,14,0.35);border-left:3px solid #c1440e"><div class="text-center"><div class="text-[0.6rem] tracking-[0.1em] uppercase font-bold text-hot">01A</div><div class="text-[0.5rem] text-paper/45 mt-0.5">Hancock</div></div><div><div class="text-[0.73rem] font-display tracking-wide mb-0.5" style="color:rgba(245,234,212,0.84)">A racist threat phoned to Hancock — over a Gina Rinehart testimonial</div><div class="text-[0.62rem] leading-relaxed" style="color:rgba(245,234,212,0.58)">After Kosta Kondratenko suggested Adam Watson send RJ a payment as a good-will gesture, RJ came across a website Kosta had built for Adam that carried a <strong class="text-paper/75">testimonial from Gina Rinehart</strong>. RJ is reported to have telephoned <strong class="text-paper/75">Hancock</strong> and said: <em class="text-paper/75">"I'm going to gut you like a white pig, I hate white people — give us back our land."</em> A racist threat of violence, aimed at one of the country's largest private companies, over a single line of praise on a website.</div></div></div>
                ...
                <div class="tl-row grid grid-cols-[80px_1fr] gap-4 p-4"><div class="text-center"><div class="text-[0.5rem] tracking-[0.15em] uppercase text-hot">16</div><div class="text-[0.45rem] text-paper/20 mt-0.5">Car Slur</div></div><div><div class="text-[0.6rem] font-display tracking-wide text-paper/60 mb-0.5">Homophobic slur from the backseat of a car — reportedly egged on by Bodie Chalmers</div><div class="text-[0.55rem] text-paper/30 leading-relaxed">RJ called Kosta Kondratenko a <em>"faggot"</em> from the backseat of a car, reportedly egged on by Bodie Chalmers. The interaction is on video (below). This is a reported account, not a charge — no charge arises from it and none is claimed. Afterwards, RJ is reported to have been visited by underworld figures, and is said to have remarked: <em>"Kosta ruined my life."</em></div></div></div>
            </div>
            <p class="text-[0.5rem] text-paper/25 leading-relaxed mt-3 max-w-3xl">Note on the record: the criminal matters set out above are reported as charges where charges exist. Item 16 is a reported account only — it is presented as reported, carries no charge, and no legal conclusion is drawn from it.</p>
        </div>

        <!-- Incident 16 — the video + the irony -->
        <div class="border border-hot/25 p-6 mb-12 reveal" style="background:rgba(193,68,14,0.05)">
            <div class="flex items-center gap-2 mb-3">
                <span class="text-[0.5rem] tracking-[0.2em] uppercase text-hot">Incident 16 — On Video</span>
                <span class="text-[0.42rem] tracking-[0.15em] uppercase border border-hot/50 text-hot px-1.5 py-0.5">"Faggot" — From the Backseat</span>
            </div>
            <h3 class="font-display text-2xl md:text-3xl tracking-wide mb-4 leading-tight">HE CALLED ME A FAGGOT.<br><span class="text-hot">THE IRONY WRITES ITSELF.</span></h3>
            <p class="text-[0.72rem] leading-relaxed text-paper/45 mb-4">The interaction is captured on video below. RJ leaned out from the backseat of a car and called Kosta Kondratenko a <em class="text-paper/65">"faggot"</em> — reportedly egged on by Bodie Chalmers.</p>
            <p class="text-[0.72rem] leading-relaxed text-paper/45 mb-4">The irony is hard to miss. This is a man who, on the record across this very timeline, has spent months directing unwanted advances at Adam Watson — asking repeatedly to sleep at his house, sending love hearts, dropping his shorts at a chemist. The slur he reached for is the very thing he is himself. RJ <strong class="text-paper/60">has sex with men</strong>. Using <em class="text-paper/65">"faggot"</em> as a weapon, from the mouth of someone living that life in private, isn't an insult — it's a confession dressed up as one.</p>
            <p class="text-[0.72rem] leading-relaxed text-paper/45 mb-6">And it is not a secret held quietly. The men he sleeps with have said he <strong class="text-paper/60">smells bad — a natural body odour</strong> they remark on. That is the reality behind the street bravado and the slur from the car window: a man performing contempt for something he is, to people he is intimate with, who talk about him after.</p>
            <!-- Video embed -->
            <div class="border border-hot/20" style="background:rgba(0,0,0,0.3)">
                <video controls preload="metadata" class="w-full" style="max-height:520px;display:block">
                    <source src="https://sunlightquest.s3.ap-southeast-2.amazonaws.com/rj/video_homophobic_slur.mp4" type="video/mp4">
                </video>
                <div class="px-4 py-3 border-t border-hot/15">
                    <div class="text-[0.48rem] tracking-[0.18em] uppercase text-hot/60 mb-1">Video · Homophobic slur — RJ, from the backseat of a car</div>
                    <p class="text-[0.55rem] text-paper/30 leading-relaxed">RJ calls Kosta Kondratenko a "faggot" from the backseat of a car — reportedly egged on by Bodie Chalmers.</p>
                </div>
            </div>
        </div>
