    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-12 reveal">
            ...
            <div class="space-y-px">
                ...
                <div class="tl-row grid grid-cols-[80px_1fr] gap-4 p-4"><div class="text-center"><div class="text-[0.5rem] tracking-[0.15em] uppercase text-hot">16</div><div class="text-[0.45rem] text-paper/20 mt-0.5">Car Slur</div></div><div><div class="text-[0.6rem] font-display tracking-wide text-paper/60 mb-0.5">Racial slur from the backseat of a car — reportedly egged on by Bodie Chalmers</div><div class="text-[0.55rem] text-paper/30 leading-relaxed">RJ is reported to have called Kosta Kondratenko a slur from the backseat of a car, reportedly egged on by Bodie Chalmers. This is a reported account, not a charge — no charge arises from it and none is claimed. Afterwards, RJ is reported to have been visited by underworld figures, and is said to have remarked: <em>"Kosta ruined my life."</em></div></div></div>
            </div>
